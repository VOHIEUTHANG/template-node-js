    ...
    DB.schema.dropTableIfExists(`${tableName}`).then(() => {
      DB.schema
        .createTable(`${tableName}`, function (table) {
          ...
          table
            .integer("isVerified")
            .defaultTo(USER_VERIFY_INFO_STATUS.NOT_VERIFIED);
          table
    ...
    let initialStaff = [
      {
        ...
        password:
          "9d8e0483d5a71a73d4cf762d3dfdd30d5f441a85a060d3335c0c4979ff3e0530",
        phoneNumber: "string",
      },
    ];
    DB(`${tableName}`)
...
async function customCountMemberShip(
  filter,
  searchText,
  startDate,
  endDate,
...
async function findReferedUserByUserId(
  appUserId,
  skip,
  limit,
  memberReferIdF1,
